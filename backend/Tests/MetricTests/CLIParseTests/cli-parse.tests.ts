import { CLIParser } from '../../../src/services/metrics/CLIParser';
...
describe('CLI parse Tests', () => {
    ...
    test('CLI Action - Invalid GitHub token', async () => {
        ...
        await expect(program.parseAsync(['node', 'CLIParser', 'https://github.com/owner/repo'])).rejects.toThrow('process.exit: Invalid GitHub token');
